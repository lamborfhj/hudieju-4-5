...
function Index() {
  ...
  this.handleGoto = () => {
    React.api.navigateTo({
      url: '/pages/member/index?selectMode=true&service=paperAddressees'
    });
  };
  ...
  this.handleSubmit = e => {
    ...
    this.getFileList().then(res => {
      request({
        url: app.globalData.api + "/api/operation/paper/save",
        method: 'POST',
        data: _objectSpread({}, e.value, {
          ...
          paperMemberEntityList: this.state.addressees.map(item => {
            return {
              uid: item.id
            };
          }),
...
Index = React.toClass(Index, React.Component, {
  onShow: function () {
    this.setState({
      addressees: app.globalData.selectedMembers['paperAddressees'] || []
    });
  },
  ...
  render: function () {
    ...
    return h("view", {
      ...
      name: "content",
      class: "weui-textarea",
      placeholder: "\u8BF7\u8F93\u5165\u51FD\u4EF6\u5185\u5BB9\u300C\u9009\u586B\u300D"
    }))), h("view", {
      class: "weui-cell weui-cell_without_border"
    }, h("view", {
      class: "weui-cell__bd"
    }, this.state.imgs.map((url, i4116) => h("view", {
      class: "weui-uploader__file",
      key: url,
      onTap: () => this.handlePreviewImage(url),
      onLongpress: () => this.handleDeleteImage(url),
      "data-tap-uid": 'e149_22_' + i4116,
      "data-beacon-uid": "default",
      "data-longpress-uid": 'e150_22_' + i4116
    }, h("image", {
      src: url,
      class: "img_small"
      ...
      class: "weui-cell__bd"
    }, this.state.addressees.map((member, i5222) => h("view", {
      class: "weui-uploader__file",
      key: member.id,
...
Page(React.registerPage(Index, "pages/submitpaper/index"));
