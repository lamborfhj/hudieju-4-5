...
function Index() {
  ...
  this.handleSubmit = e => {
    ...
    this.getFileList().then(res => {
      request({
        url: app.globalData.api + "/api/operation/meeting/meetingLogUpload",
        method: 'POST',
...
Index = React.toClass(Index, React.Component, {
  ...
  render: function () {
    ...
    return h("view", {
      ...
      name: "content",
      class: "weui-textarea",
      placeholder: "\u8BF7\u586B\u5199\u672C\u6B21\u4F1A\u8BAE\u7EAA\u8981"
    }))), h("view", {
      class: "weui-cell weui-cell_without_border"
    }, h("view", {
      class: "weui-cell__bd"
    }, this.state.imgs.map((url, i3077) => h("view", {
      class: "weui-uploader__file",
      key: url,
      onTap: () => this.handlePreviewImage(url),
      onLongpress: () => this.handleDeleteImage(url),
      "data-tap-uid": 'e119_22_' + i3077,
      "data-beacon-uid": "default",
      "data-longpress-uid": 'e120_22_' + i3077
    }, h("image", {
      src: url,
      class: "img_small"
...
Index.config = {
  ...
  navigationBarTitleText: '提交会议纪要内容',
  navigationBarBackgroundColor: '#292929',
  backgroundColor: '#F5f5f5'
};
Page(React.registerPage(Index, "pages/submitmeetingtext/index"));
